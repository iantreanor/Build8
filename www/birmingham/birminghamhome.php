...
<div data-role="header" data-position="fixed">
	<h1>Birmingham beer and Cider Festival</h1>
...
<li><a href="birminghamlocation.html" class="ui-btn ui-icon-location ui-btn-icon-left">LOCATION MAP</a><span class="ui-icon ui-icon-arrowthick-1-n"></span></li>
